...
public class IdentityDbSeeder : IDataSeeder
{
    ...
    private async Task SeedRolesAsync()
    {
        ...
        {
            // pomijamy tworzenie roli, jeśli już istnieje
    ...
    private async Task CreateUserAsync(SeedUser seedUser)
    {
        ...
        ((Microsoft.AspNetCore.Identity.IdentityUser)user).Email = seedUser.Email;
        ((Microsoft.AspNetCore.Identity.IdentityUser)user).NormalizedEmail = seedUser.Email.ToUpper();
        user.Activate();
